	...
	<div class="w3-main" style="margin-left: 250px">
		...
		<div class="w3-display-container w3-container">
				<table>
					...
					<tr>
						<th><input type="text" name="productQuantity" value="Anzahl" style="width: 45%"></th>
					</tr>
					<tr>
						<th><input type="text" name="productPrice" value="Preis" style="width: 45%"></th>
					</tr>
					<tr>
					...
					<tr>
						<th><input type="submit" value="Hinzufügen" style="width: 45%; height: 50px; background-color: green; color: white"></th>
					</tr>
				</table>
