  ...
  <div class="panel-group" id="accordion">
    ...
    <div class="panel panel-default">
      ...
      <div id="collapse2" class="panel-collapse collapse">
        <div class="panel-body">   <% CreditCard creditCard=dao.getobject(CreditCard.class, customer.getCreditCardInfo()); %>
    ...
    <div class="panel panel-default">
      ...
      <div id="collapse3" class="panel-collapse collapse">
        <div class="panel-body"><%
			...
			Address address1 = dao.getobject(Address.class, customer.getShippingAddress());
	%>
      ...
      <div id="collapse4" class="panel-collapse collapse">
        <div class="panel-body"><%
			...
			Address address = dao.getobject(Address.class, customer.getBillingAddress());
	%>
      ...
      <div id="collapse5" class="panel-collapse collapse">
        ...
        <% 
     	List<OrderDetail> orderDetails2=dao.getobjects(OrderDetail.class);
        List<OrderDetail> orderDetails=new ArrayList<OrderDetail>();
        for(int i=0; i<customerOrders.size();i++){
        	for(int j=0;j<orderDetails2.size();j++){
        		if(customerOrders.get(i).getOrderId().equals(orderDetails2.get(j).getOrderId())){
        			orderDetails.add(orderDetails2.get(j));
        		}
        	}
        }
	...
	<tr> 
		...
		<% for(int j=0;j<orderDetails.size();j++){ 
				...
				for(int k=0;k<products.size();k++){
					...
					if(products.get(k).getProductId().equals(orderDetails.get(j).getProductId()) && orderDetails.get(j).getOrderId().equals(customerOrders.get(i).getOrderId())){
