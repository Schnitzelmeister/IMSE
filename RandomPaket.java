...
public class RandomPaket {
	...
	public static void main(String args[]){
		System.out.print(generateRandomEmailAccounts(generateFullNames(500)));
	}
	...
	public static ArrayList<Integer> generateRandomInteger(Integer quantityOfRandomNumbers, Integer randomFromNumber, Integer randomUpToNumber){
		...
		public static ArrayList<String> generateRandomMobileNumbers(Integer quantityOfRandomMobileNumbers){
			...
			for(int i=0;i<quantityOfRandomMobileNumbers;i+=5){
				randomMobileNumbers.add("0664/"+randomNumbers.get(i));
				randomMobileNumbers.add("0676/"+randomNumbers.get(i+1));
				randomMobileNumbers.add("0660/"+randomNumbers.get(i+2));
				randomMobileNumbers.add("0699/"+randomNumbers.get(i+3));
				randomMobileNumbers.add("0680/"+randomNumbers.get(i+4));
			}	
		...
		public static ArrayList<String> generateRandomEmailAccounts(ArrayList<String> fullNamesList){
			...
			for(int i=0;i<100;i+=5){
				...
				EmailAccounts.add(formattedNamesForEmailAccounts.get(i+1)+"@gmail.com");
				EmailAccounts.add(formattedNamesForEmailAccounts.get(i+2)+"@gmx.at");
				EmailAccounts.add(formattedNamesForEmailAccounts.get(i+3)+"@webmail.com");
				EmailAccounts.add(formattedNamesForEmailAccounts.get(i+4)+"@google.com");
			}
